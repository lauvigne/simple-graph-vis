...
export const storageFixture: StorageData = {
  ...
  graph: {
    nodes: [
      ...
      { k: 'application:wide', i: 'wide', t: 'application', l: 'Wide App', m: { entity: 'E1' } },
      { k: 'application:narrow', i: 'narrow', t: 'application', l: 'Narrow App', m: { entity: 'E1' } },
      { k: 'application:partial', i: 'partial', t: 'application', l: 'Partial App', m: { entity: 'E1' } },
      { k: 'application:other', i: 'other', t: 'application', l: 'Other Entity App', m: { entity: 'E2' } },
      { k: 'entity:E2', i: 'E2', t: 'entity', l: 'E2' },
      { k: 'businessCapacity:l1', i: 'l1', t: 'businessCapacity', l: 'L1' },
      { k: 'businessCapacity:l2', i: 'l2', t: 'businessCapacity', l: 'L2' },
      { k: 'businessCapacity:l3a', i: 'l3a', t: 'businessCapacity', l: 'L3 A' },
      { k: 'businessCapacity:l3b', i: 'l3b', t: 'businessCapacity', l: 'L3 B' },
      { k: 'businessCapacity:l3c', i: 'l3c', t: 'businessCapacity', l: 'L3 C' },
    ],
    edges: [
